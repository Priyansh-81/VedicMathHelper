...
public class Sutra11Activity extends AppCompatActivity {
    ...
    String[] teach = {
            ...
            "🧠 Break big numbers into smaller parts, then combine",
            "📘 Example: 12 × 13",
            "12 × (10 + 3)",
            "12×10 = 120",
            "12×3 = 36",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sutra11);
    ...
    void showCompletionOptions() {
        questionText.setText("🏆 Sutra 11 Complete!");
        hintText.setText("You solved 3 part-whole questions!");
        solutionText.setText("Excellent breakdown skills!");
        ...
        nextBtn.setOnClickListener(v -> {
            Intent intent = new Intent(this, Sutra12Activity.class);
    ...
    void showTeach() {
        ...
        questionText.setText("Sutra 11 Learning");
        hintText.setText("");
    ...
    void generateQuestion() {
        ...
        hintText.setText("Break second number into parts");
