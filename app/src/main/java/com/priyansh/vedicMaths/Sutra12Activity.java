...
public class Sutra12Activity extends AppCompatActivity {
    ...
    int number, divisor, correctAnswer;

    Handler handler = new Handler();
    Random random = new Random();

    String[] teach = {
            "✨ Shesanyankena Charamena = Remainder by last digit",
            "🧠 Quick remainder tricks using final digits",
            "📘 Example: 47 ÷ 5",
            "Largest multiple of 5 below 47 is 45",
            "47 - 45 = 2",
            "🎉 Remainder = 2",
            "🚀 Ready for Practice!"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sutra12);
    ...
    void showCompletionOptions() {
        questionText.setText("🏆 Sutra 12 Complete!");
        hintText.setText("You solved 3 remainder questions!");
        solutionText.setText("Great divisibility skills!");
        ...
        nextBtn.setOnClickListener(v -> {
            Intent intent = new Intent(this, sutra13Activity.class);
    ...
    void showTeach() {
        ...
        questionText.setText("Sutra 12 Learning");
        hintText.setText("");
    ...
    void generateQuestion() {
        divisor = random.nextInt(8) + 2; // 2 to 9
        number = random.nextInt(90) + 10; // 10 to 99
        correctAnswer = number % divisor;

        questionText.setText("Remainder of " + number + " ÷ " + divisor);
        hintText.setText("Find only the remainder");
